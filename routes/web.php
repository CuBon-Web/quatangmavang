...
Route::get('/sitemaps.xml', 'SitemapController@index');
...
Route::get('/sitemaps/product-cate.xml', 'SitemapController@productCate')->name('sitemap.productCate');
Route::get('/sitemaps/product-type.xml', 'SitemapController@productType')->name('sitemap.productType');
Route::get('/sitemaps/blog-type.xml', 'SitemapController@blogType')->name('sitemap.blogType');
...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('process-step','PageController@processStep')->name('processStep');
    ...
    Route::get('project-category/{slug}.html','PageController@projectCategory')->name('projectCategory');
    Route::get('list-project.html','PageController@duanTieuBieu')->name('duanTieuBieu');
    ...
    Route::get('payos/return','CartController@payosReturn')->name('payos.return');
    Route::get('payos/cancel','CartController@payosCancel')->name('payos.cancel');
    Route::post('payos/webhook','CartController@payosWebhook')->name('payos.webhook');
    ...
    Route::group(['prefix'=>'tin-tuc'], function(){
        ...
        Route::get('the/{tag}.html','BlogController@listByTag')->name('listBlogTag');
    ...
    Route::match(['get', 'post'], 'ket-qua-tim-kiem', 'ProductController@searchResult')->name('search_result');
